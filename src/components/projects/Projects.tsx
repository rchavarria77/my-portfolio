...
const PROJECTS: IProject[] = [
  {
    ...
    title: 'CPI Website',
    description:
      'Official site for CPI Spanish Immersion School located in Costa Rica. They provide opportunities to study Spanish in three different locations and they also offer online learning options. This website provides a comprehensive overview of their programs, locations, and the unique experiences they offer.',
  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col gap-4'>
        {PROJECTS.map(
          ({ id, title, description, url, image, tags }: IProject) => (
            <article key={id}>
              <Card>
