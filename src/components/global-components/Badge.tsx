export const Badge = ({ children }: { children: any }) => {
  return (
    <span className='relative flex overflow-hidden rounded-full p-[1px] max-w-fit'>
      ...
      <div className='inline-flex items-center justify-center w-full h-full px-3 py-1 text-sm font-medium text-white rounded-full cursor-pointer bg-ebony-900/45 dark:bg-ebony-900/45 backdrop-blur-3xl whitespace-nowrap'>
        {children}
      </div>
    </span>
  );
